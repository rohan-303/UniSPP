...
output_dir = "/home/careinfolab/Dr_Luo/Rohan/UniSPP/Results/Without_UniSPP/LSTM"
...
def objective(trial):
    ...
    model = LSTMModel(X_train_tensor.shape[2], hidden_dim, 1, num_layers, act_fn).to(device)
...
final_model = LSTMModel(X_train_tensor.shape[2],
                        best["hidden_dim"],
                        1,
                        best["num_layers"],
