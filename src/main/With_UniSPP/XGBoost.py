...
output_dir = "/home/careinfolab/Dr_Luo/Rohan/UniSPP/Results/With_UniSPP/XGB"
...
def evaluate_xgb(subgraph, df_train, df_test, base_features, xgb_params):
...
def unispp_optimize_with_phi(df_train, df_test, edges, phi, feature_index, base_features, xgb_params, trials, samples_per_trial, num_edges, lr):
    ...
    for _ in range(trials):
        for _ in range(samples_per_trial):
            ...
            mae, rmse, nrmse = evaluate_xgb(subgraph, df_train, df_test, base_features, xgb_params)
...
def objective(trial):
    ...
    mae, rmse, nrmse, subgraph = unispp_optimize_with_phi(
        df_train, df_test, edges, phi, feature_index, features, xgb_params,
